...
public void OnPluginStart()
{
	...
	HookEvent("player_entered_start_area", Event_PlayerEnterStart, EventHookMode_PostNoCopy);
	HookEvent("player_entered_checkpoint", Event_PlayerEnterCheckpoint, EventHookMode_PostNoCopy);
...
public void Event_PlayerEnterStart(Event hEvent, const char[] sEventName, bool bDontBroadcast)
{
	DetermineItems();
}

public void Event_PlayerEnterCheckpoint(Event hEvent, const char[] sEventName, bool bDontBroadcast)
{
	DetermineItems();
}
